...
<head>
    ...
    <title>NEXUS Weather - Sign Up</title>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; cursor:none; }
        ...
        .btn-submit { width:100%; padding:16px; border:none; border-radius:50px; background:linear-gradient(135deg,var(--neon-cyan),var(--neon-purple)); color:#000; font-weight:900; font-size:0.95rem; letter-spacing:2px; text-transform:uppercase; cursor:none; transition:0.3s; font-family:'Inter',sans-serif; margin-top:5px; }
        .btn-submit:hover { opacity:0.85; transform:translateY(-2px); box-shadow:0 0 30px rgba(0,245,255,0.3); }

        .terms-text { font-size:0.75rem; color:rgba(255,255,255,0.3); text-align:center; margin-top:15px; line-height:1.6; }
        .terms-text a { color:var(--neon-purple); text-decoration:none; }
    </style>
</head>
<body>
    <div id="cursor"></div>
    ...
    <div class="auth-wrapper">
        ...
        <div class="tab-toggle">
            ...
            <span class="tab-btn active">Sign Up</span>
        </div>
